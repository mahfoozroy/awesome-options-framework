...
class Awesome_Options_Framework {
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_enqueue_script( 'aof-js', plugin_dir_url( __FILE__ ) . 'assets/options.js', [ 'wp-color-picker', 'jquery' ], null, true );
		wp_enqueue_style( 'aof-css', plugin_dir_url( __FILE__ ) . 'assets/options.css' );
	}
